/**
 * The Shader class is responsible for writing final pixel color to the screen (GraphicWrapper),
 * from a Fragment. Subclass this base class and implement the ::shade() method.
 *
 * @author cdehais
 */
public abstract class Shader {
  ...
  public boolean isClipped(Fragment fragment) {
    return ((fragment.getX() < 0)
        || (fragment.getX() >= screen.getWidth())
        || (fragment.getY() < 0)
        || (fragment.getY() >= screen.getHeight()));
  }
}
