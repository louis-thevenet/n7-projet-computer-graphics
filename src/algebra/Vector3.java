...
public class Vector3 extends Vector {
  ...
  /**
   * Copy constructor from a Vector of size 3 or 4. For a vector of size 4, divide the 3 first
   * coordinates by the fourth.
   */
  ...
  /**
   * Makes the x, y, and z coordinates of the Vector3 cartesian, by dividing them by the homogeneous
   * coordinate w.
   */
