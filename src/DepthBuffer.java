...
public class DepthBuffer {
  ...
  /** Constructs a DepthBuffer of size width x height. The buffer is initially cleared. */
  ...
  /**
   * Test if a fragment passes the DepthBuffer test, i.e. is the fragment the closest at its
   * position.
   */
